...
Vtrans        -> 'unlocks' | 'extends' | 'creates' | 'loops in' | 'pings' | 'architects' | 'accelerates' | 'aligns' 
Vtrans_plural -> 'unlock'  | 'extend'  | 'create'  | 'loop in ' | 'ping'  | 'architect'  | 'accelerate' | 'align'
AP -> AP | A
Det -> 'a' | 'the' | 'every'
...
N -> 'community sprint' | 'account' | 'contact' | 'campaign' | 'opportunity' | 'user story' | 'bug' | 'release' | 'org' | 'instance' | 'partner' | 'ISV' | 'customer' | 'Trailblazer' | 'platform' 
N_collective -> 'analytics' | 'sprint planning' | 'backlog grooming' | 'technology' | 'digital experience' | 'social change' | 'data migration' | 'innovation' | 'business' | 'trust' | 'customer success' | 'equality' | 'value' | 'justice'
